      ...
      >
        ...
        <BaseCard>
          ...
          <ol class="list-decimal pl-4">
            <li>Has an upload button that will allow user to upload multiple files of relevant types.</li>
            <li>Shows list of thumbnails of items the user has uploaded.</li>
